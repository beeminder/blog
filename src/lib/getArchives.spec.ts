...
describe("getArchives", () => {
  beforeEach(() => {
    vi.mocked(readSources).mockReturnValue([
      {
        title: "Test Post",
        source: "https://<etherpad-host>/psychpricing",
        date: "2011-01-24",
        slug: "psychpricing",
        status: "publish",
        author: "author",
  ...
  it("properly batches by year", async () => {
    vi.mocked(readSources).mockReturnValue([
      ...
      {
        title: "Second Post",
        source: "https://<etherpad-host>/second",
        date: "2015-02-22",
        slug: "second",
        status: "publish",
        author: "author",
