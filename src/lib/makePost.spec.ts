...
describe("makePost", () => {
  ...
  it("sets disqus id", async () => {
    const result = await makePost("https://<etherpad-host>/psychpricing");
  ...
  it("returns html", async () => {
    ...
    const { content } = await makePost("https://<etherpad-host>/psychpricing");
...
`);
  ...
  it("parses frontmatter", async () => {
    ...
    const { slug } = await makePost("https://<etherpad-host>/psychpricing");
